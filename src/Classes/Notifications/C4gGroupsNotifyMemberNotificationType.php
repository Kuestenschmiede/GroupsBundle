<?php
    ...
    class C4gGroupsNotifyMemberNotificationType implements NotificationTypeInterface
    {
        public const NAME = 'notify_member';
    ...
    (
        ...
        'file_content'           => array('member_name','text_content', 'subject'),
            ...
            return [
                $this->factory->create(AnythingTokenDefinition::class, 'member_email','new_member_email'),
